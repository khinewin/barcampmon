        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="panel panel-primary newGallery">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form role="form" method="post" action="{{route('newGallery')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                @if($errors->has('photoStatus'))<span class="help-block"></span>{{$errors->first('photoStatus')}}
                                @endif
                                <input type="text" name="photoStatus" id="photoStatus" class="form-control" placeholder="Status" required>
                            </div>
                            <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <i class="fa fa-list"></i> Photo Lists
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-hover"  style="text-align: center">
                            ...
                            @foreach($gallery as $g)
                                <tr>
                                    <td><img src="{{route('photoGallery',['photoName'=>$g->photo])}}"  width="90px" height="50px"></td>
                                    <td>{{$g->title}}</td>
                                    <td>{{$g->status}}</td>
                                    <td><!-- Button trigger modal -->
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#{{$g->id}}">
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="{{$g->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{route('removeGallery',['id'=>$g->id])}}" class="btn btn-primary">Yes</a> </td>
                                            </div>
                                        </div>
                                    </div>
                                </div>
